...
import {GAS_UNITS_NATIVE_TOKEN_TRANSFER, GAS_UNITS_ERC20_TOKEN_TRANSFER} from '../constants/gas';
...
export async function getTokenTransferGasEstimate(
    ...
    const gasUnits = isERC20 ? GAS_UNITS_ERC20_TOKEN_TRANSFER : GAS_UNITS_NATIVE_TOKEN_TRANSFER;
